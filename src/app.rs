...
use crate::element::{Element, ElementInner, ElementPose};
...
impl winit::application::ApplicationHandler<ExternalEvent> for AppState {
    fn resumed(&mut self, el: &WEL::ActiveEventLoop) {
        ...
        // surface.config.alpha_mode = V::wgpu::CompositeAlphaMode::Auto;
                ...
                renderer
                    .render_to_texture(
                        ...
                        &vello::RenderParams {
                            ...
                            // base_color: V::peniko::Color::new([0., 0., 0., 0.]),
                            width,
                            height,
    ...
    fn user_event(&mut self, _event_loop: &WEL::ActiveEventLoop, event: ExternalEvent) {
        ...
        match event {
            ExternalEvent::ChangeConfig(c) => {
                ...
                window.set_visible(c.window.visible);
...
pub fn run() -> Result<()> {
    ...
    let mut elements = vec![
        ...
        Element::new(ElementInner::Shape {
            ...
            style: Style::stroked(V::peniko::color::palette::css::BLUE, Stroke::new(3.)),
        }),
        Element::new(ElementInner::Shape {
        ...
        Element::new(ElementInner::Shape {
            ...
            style: Style::stroked(V::peniko::color::palette::css::CYAN, Stroke::new(4.)),
        }),
        Element::new(ElementInner::Shape {
        ...
        Element::new(ElementInner::Shape {
            ...
            style: Style::stroked(V::peniko::color::palette::css::LIME, Stroke::new(4.)),
        }),
        Element::new(ElementInner::Shape {
        ...
        Element::new(ElementInner::Shape {
            ...
            style: Style::filled_and_stroked(
                ...
                Stroke::new(4.).with_dashes(0., [8.0, 4.0]),
            ),
        }),
        Element::new(ElementInner::Shape {
        ...
        Element::new(ElementInner::Shape {
            ...
            style: Style::stroked(V::peniko::color::palette::css::MAROON, Stroke::new(5.)),
        }),
        Element::new(ElementInner::Shape {
        ...
        Element::new(ElementInner::Shape {
            ...
            style: Style::stroked(V::peniko::color::palette::css::CRIMSON, Stroke::new(5.)),
        }),
        Element::new(ElementInner::Shape {
        ...
        Element::new(ElementInner::Shape {
            ...
            style: Style::stroked(
                V::peniko::color::palette::css::BROWN,
                Stroke::new(6.).with_dashes(0., [6.0, 3.0]),
            ),
        }),
        Element::new(ElementInner::Shape {
        ...
        Element::new(ElementInner::Shape {
            ...
            style: Style::stroked(
                V::peniko::color::palette::css::YELLOW_GREEN,
                Stroke::new(3.).with_dashes(0., [6.0, 3.0]),
            ),
        }),
        Element::new(ElementInner::Shape {
        ...
        Element::new(ElementInner::Group(vec![
            Element::new(ElementInner::Shape {
                value: K::Circle::new(K::Point::new(40., 90.), 45.).into(),
                style: Style::filled(V::peniko::color::palette::css::MAGENTA),
            }),
            Element::new(ElementInner::Shape {
                value: K::Rect::new(950., 700., 1050., 850.).into(),
            ...
            Element::new(ElementInner::Shape {
                ...
                style: Style::stroked(
                    V::peniko::color::palette::css::YELLOW_GREEN,
                    Stroke::new(7.).with_dashes(0., [6.0, 3.0]),
                ),
            }),
            Element::new(ElementInner::Shape {
                value: K::Rect::new(900., 400., 950., 500.).into(),
            ...
            Element::new(ElementInner::Shape {
                value: K::Ellipse::new(K::Point::new(950., 200.), K::Vec2::new(25., 40.), 0.)
                    .into(),
                style: Style::stroked(
                    V::peniko::color::palette::css::BROWN,
                    Stroke::new(6.).with_dashes(0., [6.0, 3.0]),
            ...
            Element::new(ElementInner::Shape {
                value: K::Ellipse::new(K::Point::new(400., 900.), K::Vec2::new(70., 20.), 15.)
                    .into(),
                style: Style::filled(V::peniko::color::palette::css::SALMON),
            }),
            Element::new(ElementInner::Shape {
    ...
    for (mut element, (x, y, rot)) in elements.into_iter().zip(transforms.iter()) {
        element.on_pose(move |s| {
            s.position.x = *x;
            s.position.y = *y;
            s.rotation = *rot;
        });
        app.editor.document.push(element);
    }
